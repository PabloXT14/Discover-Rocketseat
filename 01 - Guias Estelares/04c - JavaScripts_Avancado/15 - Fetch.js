...
- Definição:
    ...
    * RESUMINDO: o método fetch() nos permite acessar dados de fora da nossa página Web, dados enviados por alguma API externa via URL, ou seja, nos possibilitando acessar dados de algum Back-End.
